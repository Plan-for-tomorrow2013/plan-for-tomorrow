...
const kbComplyingDevelopmentPath =
  '/home/tania/urban-planning-professionals-portal/admin/admin/data/kb-complying-development-assessments.json';
...
export async function GET(request: Request) {
  try {
    ...
    try {
      ...
      console.error(
        `Admin kb complying development assessments file not found at ${kbComplyingDevelopmentPath}:`,
        accessError
      );
    ...
    if (sectionTitle) {
      ...
      const section = kbComplyingDevelopmentAssessments.find(
