...
import { ConsultantWorkOrder, ConsultantCategory } from '@shared/types/consultantsWorkOrder';
...
export async function GET() {
  try {
    ...
    const tickets: ConsultantWorkOrder[] = JSON.parse(data);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    consultantWorkOrders.push(newTicket);
...
async function createDocumentFromConsultantWorkOrder(
