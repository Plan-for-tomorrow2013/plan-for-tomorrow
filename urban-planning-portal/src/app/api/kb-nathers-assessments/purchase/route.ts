...
// Path to the kb nathers assessments data file
const kbNathersAssessmentsPath = '/home/tania/urban-planning-professionals-portal/admin/admin/data/kb-nathers-assessments.json';

// POST /api/kb-nathers-assessments/purchase
export async function POST(request: Request) {
  try {
    ...
    const assessmentsData = await fs.readFile(kbNathersAssessmentsPath, 'utf8');
