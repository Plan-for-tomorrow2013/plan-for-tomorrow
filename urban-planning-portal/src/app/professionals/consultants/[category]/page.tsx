...
export default function QuoteCategoryPage({ params }: { params: { category: string } }) {
  ...
  const [consultants, setConsultants] = useState(ConsultantsByCategory[params.category as keyof typeof ConsultantsByCategory] || [])
  ...
  return (
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <Link href="/professionals/consultants" className="flex items-center text-primary hover:underline">
