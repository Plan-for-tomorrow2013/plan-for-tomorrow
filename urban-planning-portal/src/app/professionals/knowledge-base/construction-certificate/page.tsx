...
export default function ConstructionCertificatePage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Construction Certificate" backHref="/professionals/knowledge-base" />

      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-lg mb-2">What is Construction Certificate?</h3>
            <p className="text-gray-700 mb-4">
              Construction Certificate is a certificate issued by the council to confirm that the development has been completed to the required standards.
      ...
      <div className="border rounded-lg p-4">
        <h2 className="text-xl font-semibold mb-4">Construction Certificate Resources</h2>
      ...
      {/* Construction Certificate Calculator Section */}
      <div className="border rounded-lg p-4">
        <h2 className="text-xl font-semibold mb-4">Construction Certificate Calculators</h2>
        <div className="h-1 bg-yellow-400 w-full my-2"></div>
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <p className="text-lg mb-4">
            Use our calculators to determine the requirements for your construction certificate project.
          </p>
        </div>
      </div>
      
      {/* Construction Certificate View Dialog for Text Content */}
