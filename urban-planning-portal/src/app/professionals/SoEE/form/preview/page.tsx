          ...
          <CardContent>
                    ...
                    <CardContent className="px-6 py-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p>
                            {getDevelopmentTypeDisplay(formData.project.developmentType) ||
                              'Not specified'}
                          </p>
                        </div>
                        <div>
                    ...
                    <CardContent className="px-6 py-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <p className="capitalize">
                            {formData.property.lotType || 'Not specified'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                          {Object.entries(formData.property.constraints || {}).some(
                            ([_, value]) => value
                          ) ? (
                            Object.entries(formData.property.constraints || {}).map(
                              ([key, value]) => {
                                if (value) {
                                  return (
                    ...
                    <CardContent className="px-6 py-4">
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-sm mt-1">
                          {formData.development.developmentDescription || 'Not specified'}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                          ...
                          <Table className="mt-2">
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.heightControl || 'Not specified'}
                                </TableCell>
                                <TableCell>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.fsrControl || 'Not specified'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.fsrProposed || 'Not specified'}
                                </TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>Landscaped Area</TableCell>
                                <TableCell>
                                  {formData.planning.landscapedAreaControl || 'Not specified'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.landscapedAreaProposed || 'Not specified'}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            {formData.planning.seppBasix && (
                              <Badge variant="outline">SEPP (BASIX)</Badge>
                            )}
                            ...
                            {formData.planning.seppBiodiversity && (
                              <Badge variant="outline">SEPP (Biodiversity)</Badge>
                            )}
                            ...
                            {!formData.planning.seppBasix &&
                              ...
                              !formData.planning.seppBiodiversity &&
                              !formData.planning.seppTransport && (
                                <span className="text-sm">No SEPPs specified</span>
                              )}
                          </div>
                        </div>
                      </div>
                          ...
                          <ul className="list-disc list-inside text-sm mt-1 space-y-1">
                            <li>
                              ...
                              {formData.environmental?.contextAndSetting?.overlooking
                                ? formData.environmental.contextAndSetting.overlooking.substring(
                                    0,
                                    60
                                  ) + '...'
                            ...
                            <li>
                              ...
                              {formData.environmental?.contextAndSetting?.overshadowing
                                ? formData.environmental.contextAndSetting.overshadowing.substring(
                                    0,
                                    60
                                  ) + '...'
                            ...
                            <li>
                              ...
                              {formData.environmental?.contextAndSetting?.buildingHeight
                                ? formData.environmental.contextAndSetting.buildingHeight.substring(
                                    0,
                                    60
                                  ) + '...'
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            {formData.environmental?.bushfireProne && (
                              <Badge variant="outline">Bushfire Prone</Badge>
                            )}
                            {formData.environmental?.floodProne && (
                              <Badge variant="outline">Flood Prone</Badge>
                            )}
                            {!formData.environmental?.bushfireProne &&
                              !formData.environmental?.floodProne && (
              ...
              <TabsContent value="full" className="space-y-6">
                <div className="border rounded-lg p-6 bg-white">
                  <div className="text-center mb-8">
                    ...
                    <p className="mt-2">
                      Prepared for Development Application to{' '}
                  ...
                  <Accordion type="multiple" defaultValue={['item-1']} className="w-full">
                    ...
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        <p>
                          ...
                          {formData.project.councilArea || '[Council Name]'} for{' '}
                          {formData.development.developmentDescription?.toLowerCase() ||
                            'the proposed development'}{' '}
                          at {formData.project.address || '[Property Address]'}.
                        </p>
                        <p>
                          The purpose of this Statement of Environmental Effects is to describe the
                          proposed development and to assess the potential environmental impacts of
                          the development. It also demonstrates how the proposal complies with the
                          relevant planning controls applicable to the site.
                        </p>
                        <p>
                    ...
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        ...
                        <p>
                          The subject site is legally described as Lot{' '}
                          {formData.property.lotNumber || '[Lot Number]'} in DP{' '}
                          {formData.property.dpNumber || '[DP Number]'} and is known as{' '}
                          {formData.project.address || '[Property Address]'}.
                        </p>

                        <h3 className="font-semibold mt-4">2.2 Site Description</h3>
                        <p>
                          The site is a {formData.property.lotType || 'standard'} allotment with an
                          area of{' '}
                          {formData.property.siteArea
                            ? `${formData.property.siteArea} m²`
                            : '[Site Area]'}
                          ...
                          {formData.property.siteDepth
                            ? `${formData.property.siteDepth} m`
                            : '[Depth]'}
                          .
                        </p>
                        {formData.property.gradient && (
                          <p>
                            The site has a {formData.property.gradient} gradient with a fall of
                            approximately {formData.property.fallAmount || '[Fall Amount]'} m from
                            the{' '}
                        ...
                        <ul className="list-disc list-inside ml-4 space-y-1">
                          <li>
                            ...
                            {formData.property.northDevelopment ||
                              '[Description of northern development]'}
                          </li>
                          <li>
                            <span className="font-medium">South:</span>{' '}
                            {formData.property.southDevelopment ||
                              '[Description of southern development]'}
                          </li>
                          <li>
                            <span className="font-medium">East:</span>{' '}
                            {formData.property.eastDevelopment ||
                              '[Description of eastern development]'}
                          </li>
                          <li>
                            <span className="font-medium">West:</span>{' '}
                            {formData.property.westDevelopment ||
                              '[Description of western development]'}
                          </li>
                        </ul>
                        ...
                        {Object.values(formData.property.constraints || {}).some(value => value) ? (
                          <ul className="list-disc list-inside ml-4 space-y-1">
                            ...
                            {formData.property.otherConstraints && (
                              <li>{formData.property.otherConstraints}</li>
                            )}
                          </ul>
                        ) : (
                    ...
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        ...
                        <p>
                          {formData.development.developmentDescription ||
                        ...
                        {formData.development.demolitionRequired && (
                          <>
                            ...
                            <p>
                              {formData.development.demolitionDetails || '[Demolition Details]'}
                            </p>
                          </>
                        )}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <p>
                              ...
                              {formData.development.totalGFA
                                ? `${formData.development.totalGFA}m²`
                                : '[GFA]'}
                            </p>
                            <p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p>
                              ...
                              {formData.development.sideSetbackGroundOne
                                ? `${formData.development.sideSetbackGroundOne}m`
                                : '[Side Setback]'}
                            </p>
                            <p>
                              <span className="font-medium">Side Setback (South):</span>{' '}
                              {formData.development.sideSetbackGroundTwo
                                ? `${formData.development.sideSetbackGroundTwo}m`
                                : '[Side Setback]'}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <p>
                              ...
                              {formData.development.roof || '[Roof]'}
                            </p>
                          </div>
                          <div>
                            <p>
                        ...
                        <p>
                          ...
                          {formData.development.vehicleAccess || '[Vehicle Access]'}. The
                          development will provide{' '}
                          {formData.development.carParkingSpaces || '[Number]'} car parking spaces.
                        </p>
                        <p>
                          Pedestrian access will be via{' '}
                          {formData.development.pedestrianAccess || '[Pedestrian Access]'}.
                        </p>

                        <h3 className="font-semibold mt-4">3.8 Stormwater Management</h3>
                        <p>
                          Stormwater from the development will be{' '}
                          {formData.development.stormwaterDisposal?.toLowerCase() ||
                            '[Stormwater Disposal Method]'}
                          .
                        </p>

                        <h3 className="font-semibold mt-4">3.9 Waste Management</h3>
                        <p>
                          {formData.development.wasteManagement || '[Waste Management Details]'}
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        ...
                        <p>
                          The subject site is zoned {formData.planning.zoning || '[Zoning]'} under
                          the {formData.planning.lepName || '[LEP Name]'}.
                        </p>
                        <p>
                          {formData.planning.landUsePermissibility ||
                            '[Land Use Permissibility Assessment]'}
                        </p>
                        ...
                        <div className="space-y-2">
                          {formData.planning.seppBasix && (
                            <div>
                              ...
                              <p>
                                A BASIX Certificate has been submitted with the development
                                application. The proposal satisfies the commitments made in the
                                BASIX Certificate and complies with the requirements of SEPP (BASIX)
                                2004.
                              </p>
                            </div>
                          )}
                          ...
                          {formData.planning.seppResilience && (
                            <div>
                              ...
                              <p>
                                The development has been assessed against the provisions of SEPP
                                (Resilience and Hazards) 2021. The site is not identified as being
                                affected by land contamination and the proposed development is not
                                considered to present any risk to human health or the environment.
                              </p>
                            </div>
                          )}
                          ...
                          <Table>
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.heightControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.heightProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>Floor Space Ratio</TableCell>
                                <TableCell>
                                  {formData.planning.fsrControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.fsrProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                          ...
                          <Table>
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.frontSetbackControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.frontSetbackProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              {formData.planning.secondaryFrontSetbackControl && (
                                <TableRow>
                                  ...
                                  <TableCell>
                                    {formData.planning.secondaryFrontSetbackProposed ||
                                      '[Proposed]'}
                                  </TableCell>
                                </TableRow>
                              )}
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.rearSetbackGroundControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.rearSetbackGroundProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.rearSetbackUpperControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.rearSetbackUpperProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.sideSetbackNorthGroundControl ||
                                    '[Requirement]'}
                                </TableCell>
                                <TableCell>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.sideSetbackNorthUpperControl ||
                                    '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.sideSetbackNorthUpperProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.sideSetbackSouthGroundControl ||
                                    '[Requirement]'}
                                </TableCell>
                                <TableCell>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.sideSetbackSouthUpperControl ||
                                    '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.sideSetbackSouthUpperProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.siteCoverageControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.siteCoverageProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                <TableCell>Landscaped Area</TableCell>
                                <TableCell>
                                  {formData.planning.landscapedAreaControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.landscapedAreaProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  {formData.planning.parkingControl || '[Requirement]'}
                                </TableCell>
                                <TableCell>
                                  {formData.planning.parkingProposed || '[Proposed]'}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                        ...
                        {formData.planning.variationsRequired && (
                          <>
                            <h3 className="font-semibold mt-4">
                              5.5 Variations to Development Standards
                            </h3>
                            <p>{formData.planning.variationDetails || '[Variation Details]'}</p>
                            <p>
                              {formData.planning.variationJustification ||
                        ...
                        {formData.planning.additionalPlanning && (
                          <>
                            <h3 className="font-semibold mt-4">
                              5.6 Additional Planning Considerations
                            </h3>
                    ...
                    <AccordionItem value="item-5">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        ...
                        <p>
                          {formData.environmental?.publicDomain || '[Public Domain Assessment]'}
                        </p>
                        ...
                        <p>
                          {formData.environmental?.otherLandResources ||
                            '[Other Land Resources Assessment]'}
                        </p>
                        ...
                        <p>
                          {formData.environmental?.airAndMicroclimate ||
                            '[Air and Microclimate Assessment]'}
                        </p>

                        {/* Flora and Fauna */}
                        <h3 className="font-semibold mt-4">5.10 Flora and Fauna</h3>
                        <p>
                          {formData.environmental?.floraAndFauna || '[Flora and Fauna Assessment]'}
                        </p>
                        {formData.environmental?.treeRemoval && (
                          <p className="mt-2">
                            <span className="font-medium">Tree Removal:</span>{' '}
                        ...
                        <p>
                          {formData.environmental?.noiseAndVibration ||
                        ...
                        <p>
                          {formData.environmental?.naturalHazards || '[Natural Hazards Assessment]'}
                        </p>
                        {(formData.environmental?.bushfireProne ||
                          formData.environmental?.floodProne) && (
                          <div className="mt-2">
                            {formData.environmental?.bushfireProne && (
                              <p>
                                <span className="font-medium">Bushfire Prone Land:</span> The site
                                is identified as bushfire prone land.
                              </p>
                            )}
                            {formData.environmental?.floodProne && (
                              <p>
                                <span className="font-medium">Flood Prone Land:</span> The site is
                        ...
                        <p>
                          {formData.environmental?.technologicalHazards ||
                            '[Technological Hazards Assessment]'}
                        </p>
                        ...
                        <p>
                          {formData.environmental?.socialEconomicImpact ||
                        ...
                        <p>
                          {formData.environmental?.cumulativeImpacts ||
                        ...
                        {formData.environmental?.additionalInformation && (
                          <>
                            <h3 className="font-semibold mt-4">
                              5.21 Additional Environmental Considerations
                            </h3>
                    ...
                    <AccordionItem value="item-6">
                      ...
                      <AccordionContent className="space-y-4 text-sm">
                        <p>
                          This Statement of Environmental Effects has demonstrated that the proposed
                          development:
                        </p>
                        <ul className="list-disc list-inside ml-4 space-y-1">
                          <li>
                            Is permissible within the {formData.planning.zoning || '[Zoning]'} zone
                          </li>
                          <li>
                          ...
                          <li>
                            Complies with the relevant development standards in the LEP and DCP
                          </li>
                          <li>
                            Is compatible with the existing and desired future character of the area
                          </li>
                        ...
                        <p className="mt-4">
                          Based on the assessment contained in this Statement of Environmental
                          Effects, it is considered that the proposed development is worthy of
                          support by {formData.project.councilArea || '[Council Name]'}.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
            ...
            <div className="flex flex-col items-center justify-center mt-8 space-y-4">
              {!isGenerated ? (
                ...
                <>
                  <Alert className="max-w-md">
                    ...
                    <AlertDescription>
                      Your Statement of Environmental Effects has been generated and is ready to
                      download.
                    </AlertDescription>
                  </Alert>
              ...
              <p className="text-sm text-muted-foreground text-center max-w-md">
                This will generate a complete Statement of Environmental Effects document based on
