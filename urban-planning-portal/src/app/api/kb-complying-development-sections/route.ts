...
const kbComplyingDevelopmentPath = path.join(
  process.cwd(),
  '..',
  'admin',
  'data',
  'kb-complying-development-sections.json'
);
...
export async function GET() {
  try {
    ...
    try {
      ...
      console.error(
        `Admin kb complying development sections file not found at ${kbComplyingDevelopmentPath}:`,
        accessError
      );
