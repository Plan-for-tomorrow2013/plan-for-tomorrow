...
// Path to the kb waste management assessments data file
...
// POST /api/kb-waste-management-assessments/purchase
export async function POST(request: Request) {
  try {
    ...
    const assessmentsData = await fs.readFile(kbWasteManagementAssessmentsPath, 'utf8');
