  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => router.push('/professionals/dashboard')}>
          Create New Job
        </Button>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {filteredJobs.map((job) => (
            <Card key={job.id} className="cursor-pointer hover:bg-gray-50" onClick={() => router.push(`/professionals/jobs/${job.id}`)}>
              <CardHeader>
