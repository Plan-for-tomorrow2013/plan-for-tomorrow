...
const prePreparedInitialAssessmentsPath = '/home/tania/urban-planning-professionals-portal/admin/admin/data/pre-prepared-initial-assessments.json';
...
export async function GET(request: Request) {
  try {
    ...
    if (sectionTitle) {
      ...
      const section = prePreparedInitialAssessments.find((section: { title: string }) => section.title === sectionTitle)
      if (section) {
