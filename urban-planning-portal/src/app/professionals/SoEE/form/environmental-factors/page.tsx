...
export default function EnvironmentalFactorsPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      // Public Domain
      publicDomain:
        formData.environmental.publicDomain ||
        'A contribution under the S.7.12 contribution plan is payable given the proposed development type.',

      // Utilities
      utilities:
        formData.environmental.utilities ||
      ...
      otherLandResources:
        ...
        'The development seeks a residential use on the land.',

      // Water
      water:
        formData.environmental.water ||
        "The development site has provision of Council's water services to the development site.",

      // Soils
      soils:
        formData.environmental.soils ||
      ...
      naturalHazards:
        ...
        'The site is not identified as being subject to bushfire or flooding.',
      ...
      technologicalHazards:
        ...
        'Previously addressed throughout the report – natural hazards, soils, etc.',
      ...
      siteDesign:
        formData.environmental.siteDesign ||
        'The proposed development will be located with adequate setbacks from all lot boundaries.',

      // Construction
      construction:
        formData.environmental.construction ||
        'The development will be constructed in accordance with the Building Code of Australia and relevant Australian Standards.',

      // Construction Hours
      constructionHours:
        formData.environmental.constructionHours ||
        'Construction will be carried out during standard construction hours (7:00am to 6:00pm Monday to Friday, 8:00am to 1:00pm Saturday).',

      // Erosion Control
      erosionControl:
        formData.environmental.erosionControl ||
        "Erosion control measures will be implemented during construction in accordance with Council's requirements.",

      // Dust Control
      dustControl:
        formData.environmental.dustControl ||
        "Dust control measures will be implemented during construction in accordance with Council's requirements.",

      // Cumulative Impacts
      cumulativeImpacts:
        formData.environmental.cumulativeImpacts ||
        'The development is considered to have minimal cumulative impacts on the surrounding environment.',
      ...
      <div className="container mx-auto py-10 px-4 max-w-3xl">
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Assess the environmental impacts of your development for the Statement of
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.contextAndSetting?.noise && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.contextAndSetting.noise.message}
                        </p>
                      )}
                    </div>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.accessTransportTraffic && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.accessTransportTraffic.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.publicDomain && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.publicDomain.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.otherLandResources && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.otherLandResources.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                ...
                <AccordionItem value="item-7" className="border rounded-md px-4 mt-4">
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      <Textarea
                        id="water"
                        placeholder="Describe water impacts"
                        rows={3}
                        {...form.register('water')}
                      />
                      {form.formState.errors.water && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.water.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                ...
                <AccordionItem value="item-8" className="border rounded-md px-4 mt-4">
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      <Textarea
                        id="soils"
                        placeholder="Describe soils impacts"
                        rows={3}
                        {...form.register('soils')}
                      />
                      {form.formState.errors.soils && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.soils.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.airAndMicroclimate && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.airAndMicroclimate.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.floraAndFauna && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.floraAndFauna.message}
                        </p>
                      )}
                    </div>
                ...
                <AccordionItem value="item-11" className="border rounded-md px-4 mt-4">
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      <Textarea
                        id="waste"
                        placeholder="Describe waste impacts"
                        rows={3}
                        {...form.register('waste')}
                      />
                      {form.formState.errors.waste && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.waste.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.energy && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.energy.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.noiseAndVibration && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.noiseAndVibration.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.naturalHazards && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.naturalHazards.message}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={checked =>
                          form.setValue('bushfireProne', checked === true)
                        }
                      />
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.technologicalHazards && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.technologicalHazards.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.safetySecurity && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.safetySecurity.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.socialEconomicImpact && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.socialEconomicImpact.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.siteDesign && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.siteDesign.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.constructionHours && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.constructionHours.message}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.erosionControl && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.erosionControl.message}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.dustControl && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.dustControl.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="space-y-4 pb-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.cumulativeImpacts && (
                        <p className="text-sm text-red-500">
                          {form.formState.errors.cumulativeImpacts.message}
                        </p>
                      )}
                    </div>
                  </AccordionContent>
