...
const kbWasteManagementAssessmentsPath = path.join(
  adminDataDir,
  'kb-waste-management-assessments.json'
);
...
export async function POST(request: Request) {
  try {
    ...
    let sectionIndex = kbWasteManagementAssessments.findIndex(
    ...
    await fs.writeFile(
      kbWasteManagementAssessmentsPath,
      JSON.stringify(kbWasteManagementAssessments, null, 2)
    );
